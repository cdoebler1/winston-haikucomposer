...
with open('missing_words.json') as f_obj:
    missing_words = json.load(f_obj)


def main(training_text):
    haiku = load_haiku(training_text)
...
if __name__ == '__main__':
    training_text = input(
        "What text file would you like to search for missing words?"
        )
    main(training_text)
